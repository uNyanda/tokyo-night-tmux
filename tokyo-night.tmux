...
#+--- Windows ---+
# Focus
tmux set -g window-status-current-format "$RESET#[fg=${THEME[blue]},dim] #{?#{==:#{pane_current_command},ssh},#[fg=${THEME[green]}]󰣀#[fg=${THEME[green]}] , }#[fg=${THEME[blue]},bold,nodim]$window_number#W#[nobold]#{?window_zoomed_flag, $zoom_number, $custom_pane}#[fg=${THEME[green]},bold]#{?window_last_flag, , }"
