...
# Icons
declare -A NET_ICONS
NET_ICONS[wifi_up]="#[fg=${THEME[surface2]}, bg=default]\U000f05a9"  # nf-md-wifi
NET_ICONS[wifi_down]="#[fg=${THEME[red]}, bg=default]\U000f05aa"       # nf-md-wifi_off
NET_ICONS[wired_up]="#[fg=${THEME[surface2]}, bg=default]\U000f0318" # nf-md-lan_connect
NET_ICONS[wired_down]="#[fg=${THEME[red]}, bg=default]\U000f0319"      # nf-md-lan_disconnect
NET_ICONS[traffic_tx]="#[fg=${THEME[blue]}, bg=default]\U000f06f6"    # nf-md-upload_network
NET_ICONS[traffic_rx]="#[fg=${THEME[green]}, bg=default]\U000f06f4"   # nf-md-download_network
NET_ICONS[ip]="#[fg=${THEME[surface2]}, bg=default]\U000f0a5f"       # nf-md-ip
...
RX_SPEED="#[fg=${THEME[surface2]}, bg=default]$(readable_format "$RX_DIFF" "$TIME_DIFF")"
TX_SPEED="#[fg=${THEME[surface2]}, bg=default]$(readable_format "$TX_DIFF" "$TIME_DIFF")"
