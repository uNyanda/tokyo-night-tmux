...
#+--- Bars LEFT ---+
# Session name
tmux set -g status-left "#[fg=${THEME[lavender]},bg=default, nobold]#[fg=${THEME[surface2]},bg=${THEME[lavender]},bold]#{?client_prefix,󰔢,#[dim] 󰨚} #[bold,nodim]$weather_status#[fg=${THEME[lavender]},bg=default,nobold]"
