...
weather_status="#(curl -s wttr.in/Hammarsdale?format="%%t+%%c")"

#+--- Bars LEFT ---+
# Session name
#tmux set -g status-left "#[fg=#{?client_prefix,${THEME[yellow]},${THEME[lavender]},bg=default, nobold]#[fg=${THEME[surface2]},bg=#{?client_prefix,${THEME[yellow]},${THEME[lavender]},bold]#{?client_prefix,󱚨 ,#[dim]󰿇 } #[bold,nodim]$weather_status#[fg=#{?client_prefix,${THEME[yellow]},${THEME[lavender]},bg=default,nobold]"
tmux set -g status-left "#[fg=#{?client_prefix,${THEME[yellow]},${THEME[lavender]}},bg=default,nobold]#[fg=${THEME[surface2]},bg=default,bold]#{?client_prefix,󱚨 ,#[dim]󰿇 } #[fg=#{?client_prefix,${THEME[yellow]},${THEME[lavender]}},bg=default,nobold]"
